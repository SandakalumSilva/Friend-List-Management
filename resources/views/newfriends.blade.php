                ...
                <div class="col-12 col-lg-9 col-xl-7">
                  <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                    <div class="card-body p-4 p-md-5">
                      <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">New Invitation</h3>
                      <form id="inviteFriends">
                        @csrf

                        <div class="row">
                            @foreach($data as $datas)
                            <input type="hidden" name="userId" value="{{$datas}}">
                            @endforeach
                            <ul id="error_msg"></ul>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-6">
                                <div class="mt-4 pt-2">
                                    <button type="submit" id="btncheck"  class="btn btn-primary btn-lg">Submit</button>
                                  </div>
                              </div>    
                        </div>   
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h3>Now your Email and Name Added to friend list.</h3>
          </div>
