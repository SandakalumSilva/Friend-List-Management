                ...
                <div class="col-12 col-lg-9 col-xl-7">
                  <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                    <div class="card-body p-4 p-md-5">
                      <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Email Validation</h3>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 mb-6">
                            ...
                            <div class="form-outline">
                              ...
                              <input type="text" placeholder="Enter OTP" name="otp" id="otp" class="form-control form-control-lg" />                              
                            </div>
          
                          </div>
                          <div class="col-md-6 mb-6">
                            <div class="mt-4 pt-2">
                                <button type="submit" id="btncheck"  class="btn btn-primary btn-lg">Validate</button>
                              </div>
                          </div>
                        </div>     
                      ...
                      <form id="resendOtp">
                        ...
                        <div class="row">
                          <div class="col-md-4 mb-4">
                            <ul id="error_msg"></ul>
                            <div class="mt-4 pt-2">
                                <button type="submit" id="btncheck"  class="btn btn-dark">Re-send OTP</button>
                            </div>
                          </div>
